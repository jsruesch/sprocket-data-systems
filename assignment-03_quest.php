    ...
    <section>
      ...
      <!-- Heatmap Legend -->
        ...
        <div class="full pad30">
         ...
         <!-- Heatmap Marker Legend : Halloween -->
<div class="full mar20-top">
   <div class="full mar5-bot"><h4 class="text-sprocket-slate text-extrabold">Heatmap : <span class="text-sprocket-dblue">Halloween</span></h4></div>
   <div class="full grid-2col ggap-10 mar10-bot">
      ...
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-orange-a"></span> Friend Without Costume</h5>
      </div>
   </div>
   <div class="full grid-2col ggap-10 mar10-bot">
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-yellow-b"></span> Candy Choice</h5>
      </div>
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-green-b"></span> Barfy Spaceman</h5>
      </div>
   </div>
   <div class="full grid-2col ggap-10 mar10-bot">
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-teal-a"></span> Mummy</h5>
      </div>
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-yellow-a"></span> Crossing the Street</h5>
      </div>
   </div>
   <div class="full grid-2col ggap-10 mar10-bot">
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-green-a"></span> Spooky House</h5>
      </div>
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-magenta-b"></span> Firefighter</h5>
      </div>
   </div>         
   <div class="full grid-2col ggap-10 mar10-bot">
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-magenta-a"></span> Trick or Treat House A</h5>
      </div>
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-purple-a"></span> Zombie</h5>
      </div>
   </div>         
   <div class="full grid-2col ggap-10 mar10-bot">
      <div class="full box-c mar5-bot">
         <h5 class="text-sprocket-dblue"><span class="legend-marker marker-blue-b"></span> Trick or Treat House B</h5>
      </div>
   </div>         
</div><!-- END: Heatmap Marker Legend : Halloween -->
