      ...
      <div class="full box-b mar30-top">
        ...
        <div class="body">
          ...
          <a href="assignment-03_quest-student_achievements.php" class="tab-responsive react-tabs__tab left">
            ...
            <a href="assignment-03_quest-student_objectives.php" class="tab-responsive react-tabs__tab--selected left">
              <i class="fas fa-clipboard-check text-sprocket-lblue left"></i>
              <p class="">Objectives</p>
            </a>
            ...
            <div class="grid-2col ggap-20">
              <div class="full">
                <div class="full mar10-bot">
                  <h5 class="text-sprocket-dblue"><i class="fas fa-check-circle text-sprocket-green"></i> Objectives Completed</h5>
                </div>
                <div class="full box-c mar10-bot"><p class="text-sprocket-dblue">Parent a Fussy Baby</p></div>
              </div>
              <div class="full">
                <div class="full mar10-bot">
                  <h5 class="text-sprocket-dblue"><i class="fas fa-times-circle text-sprocket-red"></i> Objectives Not Completed</h5>
                </div>
                <div class="full box-c mar10-bot"><p class="text-sprocket-dblue">Manage Call From Your Boss ( Work-Family Balance )</p></div>
                <div class="full box-c mar10-bot"><p class="text-sprocket-dblue">Request Husband's Help With Baby ( Coparenting )</p></div>
                <div class="full box-c mar10-bot"><p class="text-sprocket-dblue">Chat With Stranger ( Generational Issues )</p></div>
                <div class="full box-c mar10-bot"><p class="text-sprocket-dblue">Consider Buying Gift for Husband ( Triangular Theory of Love )</p></div>
              </div>
            </div>
          </div>
        </div>
