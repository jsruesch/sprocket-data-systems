        ...
        <div class="body">
          ...
          <a href="assignment-03_quest-student_achievements.php" class="tab-responsive react-tabs__tab left">
            ...
            <div class="tab-responsive react-tabs__tab--selected left">
              <i class="fas fa-undo-alt text-sprocket-lblue left"></i>
              <p class="">Meter Resets</p>
            </div>
            ...
            <div class="grid-3col ggap-20">
              ...
              <div class="full">
                <div class="full mar10-bot">
                  <h5 class="text-sprocket-dblue">Biological Meter Resets</h5>
                </div>
                  <div class="full box-c mar10-bot"><p class="text-sprocket-dblue"><i class="fas fa-times-circle text-sprocket-red mar5-right"></i> 0 / 1</p></div>
              </div>
              
              <div class="full">
                <div class="full mar10-bot">
                  <h5 class="text-sprocket-dblue">Cognitive Meter Resets</h5>
                </div>
                  <div class="full box-c mar10-bot"><p class="text-sprocket-dblue"><i class="fas fa-check-circle text-sprocket-green mar5-right"></i> 1 / 1</p></div>
              </div>
              
              <div class="full">
                <div class="full mar10-bot">
                  <h5 class="text-sprocket-dblue">Socioemotional Meter Resets</h5>
                </div>
                  <div class="full box-c mar10-bot"><p class="text-sprocket-dblue"><i class="fas fa-check-circle text-sprocket-green mar5-right"></i> 1 / 1</p></div>
              </div>
