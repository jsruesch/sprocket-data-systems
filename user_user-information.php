  ...
  <!-- Dashboard Header -->
    ...
    <!-- Game Title -->
      <div class="game-header">
         <a href="user_user-list.php" class="left dashboard-header">Users</a>
         <div class="left divider mar10-right mar10-left"></div>
        <div class="left dashboard-header text-sprocket-altblue">User A</div>
      </div><!-- END: Game Title -->
      </div>
    ...
    <div class="full mar20-bot"><p class="text-small text-sprocket-mblue">*Do not include* This page displays all classes this user is enrolled in and the assignments for those specific classes</div>
